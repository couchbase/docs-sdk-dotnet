...
This repository hosts the documentation source for the https://docs.couchbase.com/dotnet-sdk/3.10/hello-world/overview.html[Couchbase .NET SDK].

This branch documents the 3.10 release of the SDK.
It follows the https://docs.couchbase.com/dotnet-sdk/3.11/project-docs/compatibility.html#api-version[SDK 3.10 API].
...
The philosophy behind the Information Architecture can be found in the https://docs.couchbase.com/dotnet-sdk/3.10/project-docs/metadoc-about-these-sdk-docs.html[meta doc].
...
| `name-sdk:` | Allows us to name the SDK within shared content (*.NET SDK*).
...
A value of `3` should not be used, save in exceptionally complicated pages like that shown (the https://docs.couchbase.com/dotnet-sdk/3.10/project-docs/compatibility.html[compatibility page]).
