...
`NullConfigException: NodeLocator is not defined` error against Server 6.5 and up fixed -- caused by SELECT_BUCKET being called before enabling authentication.
