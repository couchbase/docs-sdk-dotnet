...
For example:
 ...
 Install-Package CouchbaseNetClient -Version 2.7.14
...
== Version 2.7.13 (4th Dec 2019)

https://packages.couchbase.com/clients/net/2.7/Couchbase-Net-Client-2.7.14.zip[Download] | http://docs.couchbase.com/sdk-api/couchbase-net-client-2.7.14[API Reference] | https://www.nuget.org/packages/CouchbaseNetClient/2.7.14[Nuget]
...
* https://issues.couchbase.com/browse/NCBC-2179[NCBC-2179]: LookupIn does not correctly parse config returned by NMVB
* https://issues.couchbase.com/browse/NCBC-2192[NCBC-2192]: Sub-document remove encodes null value and triggers server invalid arguments.

=== New Features and Behavioral Changes

* https://issues.couchbase.com/browse/NCBC-2198[NCBC-2198]: Create additional Sub-Document test to verify NCBC-2038
