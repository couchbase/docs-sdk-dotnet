...
For example:
 ...
 Install-Package CouchbaseNetClient -Version 2.7.26
...
== Version 2.7.27 (1st February 2022)

https://packages.couchbase.com/clients/net/2.7/Couchbase-Net-Client-2.7.27.zip[Download] |
http://docs.couchbase.com/sdk-api/couchbase-net-client-2.7.27[API Reference] |
https://www.nuget.org/packages/CouchbaseNetClient/2.7.27[Nuget]
...
* https://issues.couchbase.com/browse/NCBC-2997[NCBC-2997] : SDK returns false when checking for exist in Couchbase 7.
* https://issues.couchbase.com/browse/NCBC-3093[NCBC-3093] : ClientConfiguration.NetworkType is not correctly assigned to the bucket config.
* https://issues.couchbase.com/browse/NCBC-3098[NCBC-3098] : NMVB when using Alternate Addresses.

== Version 2.7.26 (2nd June 2021)

https://packages.couchbase.com/clients/net/2.7/Couchbase-Net-Client-2.7.26.zip[Download] |
http://docs.couchbase.com/sdk-api/couchbase-net-client-2.7.26[API Reference] |
https://www.nuget.org/packages/CouchbaseNetClient/2.7.26[Nuget]
...
* https://issues.couchbase.com/browse/NCBC-2872[NCBC-2872]: NullReference encountered on GetDocumentFromReplicaAsync and GetFromReplicaAsync when ssl is enabled.
* https://issues.couchbase.com/browse/NCBC-2873[NCBC-2873]: SharedConnectionPool System.ArgumentOutOfRangeException: Index was out of range.

== Version 2.7.25 (13th May 2021)

https://packages.couchbase.com/clients/net/2.7/Couchbase-Net-Client-2.7.25.zip[Download] |
http://docs.couchbase.com/sdk-api/couchbase-net-client-2.7.25[API Reference] |
https://www.nuget.org/packages/CouchbaseNetClient/2.7.25[Nuget]
...
* https://issues.couchbase.com/browse/NCBC-2849[NCBC-2849]: 
Ensure FF Maps is only used after a NMVB.


== Version 2.7.24 (10th April 2021)

https://packages.couchbase.com/clients/net/2.7/Couchbase-Net-Client-2.7.24.zip[Download] |
http://docs.couchbase.com/sdk-api/couchbase-net-client-2.7.24[API Reference] |
https://www.nuget.org/packages/CouchbaseNetClient/2.7.24[Nuget]
...
* https://issues.couchbase.com/browse/NCBC-2840[NCBC-2840]:
 Mismatch between seconds/milliseconds with K/V timeouts
