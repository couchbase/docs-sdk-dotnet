...
:page-partial:
:page-aliases: relnotes-dotnet-sdk,release-notes,download-links,project-docs:migrating-sdk-code-to-3.n,project-docs:sdk-release-notes
...
https://packages.couchbase.com/clients/net/2.5/Couchbase-Net-Client-2.7.13.zip[Download] | http://docs.couchbase.com/sdk-api/couchbase-net-client-2.7.13[API Reference] | https://www.nuget.org/packages/CouchbaseNetClient/2.7.13[Nuget]
...
* https://issues.couchbase.com/browse/NCBC-2146[NCBC-2146]: SSL connection shouldn&#39;t release itself
* https://issues.couchbase.com/browse/NCBC-2152[NCBC-2152]: SslConnection doesn&#39;t clean-up correctly
* https://issues.couchbase.com/browse/NCBC-2159[NCBC-2159]: SslConnection.Send doesn&#39;t configure awaiter correctly

=== New Features and Behavioral Changes

* https://issues.couchbase.com/browse/NCBC-2148[NCBC-2148]: Bootstrap connection pool connections in parallel
* https://issues.couchbase.com/browse/NCBC-2163[NCBC-2163]: Don&#39;t jump to async from sync call in SslConnection
