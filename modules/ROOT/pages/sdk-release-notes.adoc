...
=== Fixed Issues
* https://issues.couchbase.com/browse/NCBC-2036[NCBC-2036]: RTO tick precision is not consistent between platforms
* https://issues.couchbase.com/browse/NCBC-2037[NCBC-2037]: Setting CertAuthenticator in config doesn&#39;t set EnableCertificateAuthentication
* https://issues.couchbase.com/browse/NCBC-2038[NCBC-2038]: SubDoc MutateIn multimutate cannot set property values to null

=== New Features and Behavioral Changes
* https://issues.couchbase.com/browse/NCBC-1974[NCBC-1974]: Add nuget.config that includes default package source
