...
* https://issues.couchbase.com/browse/NCBC-2200[NCBC-2200]: Thrown SendTimeoutExpiredException does not close the connection 
* https://issues.couchbase.com/browse/NCBC-2235[NCBC-2235]: Executing multiple lookup gets with different types fails
* https://issues.couchbase.com/browse/NCBC-2342[NCBC-2342]: Couchbase.IO.SharedConnectionPools.Acquire sometimes throws IndexIndexOutOfRangeException
