...
https://packages.couchbase.com/clients/net/2.7/Couchbase-Net-Client-2.7.17.zip[Download] | http://docs.couchbase.com/sdk-api/couchbase-net-client-2.7.17[API Reference] | https://www.nuget.org/packages/CouchbaseNetClient/2.7.17[Nuget]
...
* https://issues.couchbase.com/browse/NCBC-1945[NCBC-1945]: SDK client fails to apply new rev map with HTTP bootstrap
* https://issues.couchbase.com/browse/NCBC-2465[NCBC-2465]: Ping not recording failures for non-KV services
* https://issues.couchbase.com/browse/NCBC-2361[NCBC-2361]: Don't export fuzziness or prefix_length when values less than 1
