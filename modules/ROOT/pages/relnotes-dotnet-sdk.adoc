...
Certain Prepared statements could produce `Fatal error: unexpected end of JSON input`.
...
.NETCore SDK N1QL query throws System.PlatformNotSupportedException on some .NET Core platforms.
 A workaround is available.
* https://issues.couchbase.com/browse/NCBC-1502[NCBC-1502]:
Certain prepared statements may produce `Fatal error: unexpected end of JSON input`.
