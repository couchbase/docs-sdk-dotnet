...
* https://issues.couchbase.com/browse/NCBC-1838[NCBC-1838]: Default timeout is set as seconds as opposed to milliseconds
* https://issues.couchbase.com/browse/NCBC-1843[NCBC-1843]: In LookupIn last command is not always parsed correctly
* https://issues.couchbase.com/browse/NCBC-1845[NCBC-1845]: Status code OperationTimeout (Code 512) with DocumentDoesNotExistException
