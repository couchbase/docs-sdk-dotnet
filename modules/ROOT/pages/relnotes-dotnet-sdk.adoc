...
* https://issues.couchbase.com/browse/NCBC-1696[NCBC-1696] - Add alternate name/alternate port config support

=== Fixed Issues

* https://issues.couchbase.com/browse/NCBC-1831[NCBC-1831] - Update VersionSuffix to 2.7.4
</li>
* https://issues.couchbase.com/browse/NCBC-1712[NCBC-1712] - Add .editorconfig to help enforce solution formatting standards
</li>
* https://issues.couchbase.com/browse/NCBC-1778[NCBC-1778] - Improve SendWithDurabilityAsync testability using mocks
</li>
* https://issues.couchbase.com/browse/NCBC-1825[NCBC-1825] - Remove build-utils folder
</li>
* https://issues.couchbase.com/browse/NCBC-1829[NCBC-1829] - Ensure assembly is optimized when building in Release configuration
</li>
* https://issues.couchbase.com/browse/NCBC-1830[NCBC-1830] - Add new license SPDX license identifier for Apache 2.0
</li>
