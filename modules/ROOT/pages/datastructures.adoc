...
This operation uses xref:5.1@server:developer-guide:cas-concurrency.adoc[CAS] to ensure the correct item is removed.
...
This operation uses xref:5.1@server:developer-guide:cas-concurrency.adoc[CAS] to ensure no two processs can retrieve the same item.
...
This operation uses xref:5.1@server:developer-guide:cas-concurrency.adoc[CAS] to ensure no two calls gets the same item.
