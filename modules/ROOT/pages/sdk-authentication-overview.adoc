...
To authenticate with Couchbase Server by means of a client certificate, you will need a key - although the key can be generated following the instructions  on the xref:6.0@server:security:security-x509certsintro.adoc[X.509 for TLS page], you do not need a Java Key Store.
