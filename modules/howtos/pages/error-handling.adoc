...
Please refer to each individual method (API docs) for more information about which exceptions are thrown on top of the `TimeoutException` and `RequestCanceledException`.
