...
[source,csharp]
----
include::example$ErrorHandling.cs[tag=readonly,indent=0]
----
...
[source,csharp]
----
include::example$ErrorHandling.cs[tag=getfetch,indent=0]
----
...
[source,csharp]
----
include::example$ErrorHandling.cs[tag=getcatch,indent=0]
----
...
[source,csharp]
----
include::example$ErrorHandling.cs[tag=tryupsert,indent=0]
----
...
[source,csharp]
----
include::example$ErrorHandling.cs[tag=customglobal,indent=0]
----
...
[source,csharp]
----
include::example$ErrorHandling.cs[tag=customreq,indent=0]
----
...
[source,csharp]
----
include::example$ErrorHandling.cs[tag=customclass,indent=0]
----
...
[source,csharp]
----
include::example$ErrorHandling.cs[tag=failfastcircuit,indent=0]
----
