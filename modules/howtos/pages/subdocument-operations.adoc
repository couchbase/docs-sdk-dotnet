...
[source,csharp]
----
include::example$SubDocument.cs[tag=get,indent=0]
----

.Check existence of Sub-Document path
[source,csharp]
----
include::example$SubDocument.cs[tag=exists,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=combine,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=upsert,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=insert,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=multi,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=array-append,indent=0]
----

[source,csharp]
----
include::example$SubDocument.cs[tag=array-prepend,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=array-create,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=array-upsert,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=array-unique,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=array-insert,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=counter-inc,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=counter-dec,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=create-path,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=concurrent,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.cs[tag=cas,indent=0]
----
