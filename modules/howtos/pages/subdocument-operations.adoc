...
[source,csharp]
----
include::example$SubDocument.csx[tag=get,indent=0]
----

.Check existence of Sub-Document path
[source,csharp]
----
include::example$SubDocument.csx[tag=exists,indent=0]
----
...
be checked with `ContentAs<bool>(index)`, as in the example.
...
[source,csharp]
----
include::example$SubDocument.csx[tag=combine,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=upsert,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=insert,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=multi,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=array-append,indent=0]
----

[source,csharp]
----
include::example$SubDocument.csx[tag=array-prepend,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=array-create,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=array-upsert,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=array-unique,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=array-insert,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=counter-inc,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=counter-dec,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=create-path,indent=0]
----
...
[source,java]
----
include::example$Couchbase.Examples.KV/SubDocument/Program.cs[tag=lookup-in-any-replica,indent=0]
----
...
[source,java]
----
include::example$Couchbase.Examples.KV/SubDocument/Program.cs[tag=lookup-in-all-replicas,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=concurrent,indent=0]
----
...
[source,csharp]
----
include::example$SubDocument.csx[tag=cas,indent=0]
----
