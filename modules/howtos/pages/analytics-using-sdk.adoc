...
as you will have seen when working through our xref:6.6@server:analytics:primer-beer.adoc[introductory primer].
...
In .NET SDK 3.1, Deferred Queries have an Interface Level of xref:project-docs:compatibility.adoc#interface-stability[Volatile].
...
NOTE: In .NET SDK 3.1, KV Ingest has an Interface Level of xref:project-docs:compatibility.adoc#interface-stability[Uncommited].
