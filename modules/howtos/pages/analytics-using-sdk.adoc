...
In .NET SDK 3.0, Deferred Queries have an Interface Level of xref:project-docs:compatibility-versions-features.adoc#interface-stability[Volatile].
...
NOTE: In .NET SDK 3.0, KV Ingest has an Interface Level of xref:project-docs:compatibility-versions-features.adoc#interface-stability[Uncommited].
