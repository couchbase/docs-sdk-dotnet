...
NOTE: The encryption code is packaged as an optional library because it is released under a https://github.com/couchbase/dotnet-couchbase-encryption/blob/master/LICENSE.md[different license^] from the Couchbase .NET SDK.
...
[source,csharp]
----
include::example$EncryptingUsingSdk.cs[tag=encrypting_using_sdk_1,indent=0]
----
