...
NOTE: The encryption code is packaged as an optional library because it is released under a https://github.com/couchbase/dotnet-couchbase-encryption/blob/master/LICENSE.md[different license^] than the Couchbase .NET SDK.
...
* .NET Couchbase Encryption version `3.0.0` or later.
...
[source,csharp]
----
include::example$EncryptingUsingSDK.cs[tag=configuration.cs,indent=0]
----
...
* Transparent encryption/decryption using `EncryptedFieldAttribute` on POCO's on deserialization/serialization.
...
[source,csharp]
----
include::example$EncryptingUsingSdk.cs[tag=encrypting_using_sdk_2,indent=0]
----
...
[source,csharp]
----
include::example$EncryptingUsingSDK.cs[tag=encrypting_using_sdk_3,indent=0]
----
...
[source,csharp]
----
include::example$EncryptingUsingSDK.cs[tag=encrypting_using_sdk_4,indent=0]
----
...
[source,csharp]
----
include::example$EncryptingUsingSDK.cs[tag=encrypting_using_sdk_5,indent=0]
----
...
//[source,csharp]
//----
//include::example$EncryptingUsingSDK.cs[tag=encrypting_using_sdk_6,indent=0]
//----
...
//[source,csharp]
//----
//include::example$EncryptingUsingSDK.cs[tag=encrypting_using_sdk_7,indent=0]
//----
...
[source,csharp]
----
include::example$EncryptingUsingSDK.cs[tag=encrypting_using_sdk_8,indent=0]
----
...
[source,csharp]
----
include::example$EncryptingUsingSDK.cs[tag=encrypting_using_sdk_9,indent=0]
----
...
[source,csharp]
----
include::example$EncryptingUsingSDK.cs[tag=legacy_field_name_prefix,indent=0]
----
...
[source,csharp]
----
include::example$EncryptingUsingSDK.cs[tag=legacy_decrypters,indent=0]
----
