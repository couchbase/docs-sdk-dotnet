...
[source,csharp]
----
include::example$KvOperations.cs[tag=named-collection-upsert,indent=0]
----
...
[source,csharp]
----
include::example$RangeScan.cs[tag=rangeScanAllDocuments,indent=0]
----
...
[source,csharp]
----
include::example$RangeScan.cs[tag=rangeScanPrefix,indent=0]
----
...
[source,csharp]
----
include::example$RangeScan.cs[tag=rangeScanSample,indent=0]
----
...
[source,csharp]
----
include::example$RangeScan.cs[tag=rangeScanAllDocumentIds,indent=0]
----
