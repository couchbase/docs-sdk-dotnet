...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=insert,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=insertwithoptions,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=replacewithcas,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=upsertwithtimeout,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=upsertwithdurability,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=get,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=getwithtimeout,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=remove,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=touch,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=touchwithtimeout,indent=0]
----
...
(a negative number will set expiry to immediate -- creating a xref:6.6@server:learn:buckets-memory-and-storage/storage.adoc#tombstones[tombstone]).
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=binaryincrement,indent=0]
----

.Increment (with options)
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=binaryincrementwithoptions,indent=0]
----

.Decrement
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=binarydecrement,indent=0]
----

.Decrement (with options)
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=binarydecrementwithoptions,indent=0]
----
...
[source,csharp]
----
include::example$Couchbase.Examples/KvOperations.cs[tag=named-collection-upsert,indent=0]
----
