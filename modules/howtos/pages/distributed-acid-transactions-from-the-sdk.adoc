...
[source]
----
PM > Install-Package CouchbaseNetClient -Version 3.0.5
----
...
[source]
----
dotnet add package CouchbaseNetClient --version 3.0.5
----
...
// change to .NET example
// You can find further code examples on our transactions examples repository.
// https://github.com/couchbaselabs/couchbase-transactions-dotnet-examples
