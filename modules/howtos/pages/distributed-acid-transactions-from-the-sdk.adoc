...
The latest version, as of October 2020, is 1.0.0-alpha.2.

With NuGut this can be accomplished by using the NuGet Package Manager in your IDE:

[source]
----
PM > Install-Package Couchbase.Transactions -Version 1.0.0-alpha.2
----
...
[source]
----
dotnet add package Couchbase.Transactions --version 1.0.0-alpha.2
----
...
[source]
----
<PackageReference Include="Couchbase.Transactions" Version="1.0.0-alpha.2" />
----
