...
[source,csharp]
----
include::example$Auth.cs[tag=password,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=password-authenticator,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=password-before,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=password-after,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=cert,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=cert-before,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=cert-after,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=cert-rotating,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=cert-rotate-manual,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=swap-authenticator,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=tls-before,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=tls-after,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=trust-server-ca,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=trust-server-ca-factory,indent=0]
----
...
[source,csharp]
----
include::example$Auth.cs[tag=precedence-warning,indent=0]
----
