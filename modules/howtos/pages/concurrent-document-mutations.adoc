...
(For the .NET equivalent, refer to the https://docs.couchbase.com/sdk-api/couchbase-net-client/api/Couchbase.KeyValue.GetAndLockOptions.html[API documentation].)
