...
[source,csharp]
----
include::example$UserManagementExample.cs[tag=usermanagement_1,indent=0]
----

.Listing Users
[source,csharp]
----
include::example$UserManagementExample.cs[tag=usermanagement_2,indent=0]
----
...
[source,csharp]
----
include::example$UserManagementExample.cs[tag=usermanagement_3,indent=0]
----
