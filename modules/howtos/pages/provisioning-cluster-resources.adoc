...
This is a xref:6.5@server:developer-preview:collections/collections-overview.adoc[Developer Preview feature], see the https://docs.couchbase.com/sdk-api/couchbase-net-client/html/N_Couchbase_Management_Collections.htm[API doc].
