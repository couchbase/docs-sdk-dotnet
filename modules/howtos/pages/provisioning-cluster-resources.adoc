...
[source,csharp]
----
include::example$/ProvisioningResourcesBuckets.cs[tag=creatingBucketMgr,indent=0]
----
...
[source,csharp]
----
include::example$ProvisioningResourcesBuckets.cs[tag=createBucket,indent=0]
----
...
[source,csharp]
----
include::example$ProvisioningResourcesBuckets.cs[tag=updateBucket,indent=0]
----
...
[source,csharp]
----
include::example$ProvisioningResourcesBuckets.cs[tag=removeBucket,indent=0]
----
...
[source,csharp]
----
include::example$ProvisioningResourcesBuckets.cs[tag=flushBucket,indent=0]
----
...
[source,csharp]
----
include::example$CollectionManager.cs[tag=create-collection-manager,indent=0]
----
...
[source,csharp]
----
include::example$CollectionManager.cs[tag=create-scope,indent=0]
----
...
[source,csharp]
----
include::example$CollectionManager.cs[tag=create-collection,indent=0]
----
...
[source,csharp]
----
include::example$CollectionManager.cs[tag=drop-collection,indent=0]

include::example$CollectionManager.cs[tag=drop-scope,indent=0]
...
[source,csharp]
----
include::example$CollectionManager.cs[tag=scopeAdmin, indent=0]
----
...
[source,csharp]
----
include::example$CollectionManager.cs[tag=listing-scope-collection,indent=0]
----
...
[source,csharp]
----
include::example$QueryIndexManagerExample.cs[tag=creating-index-mgr,indent=0]
----
...
[source,csharp]
----
include::example$QueryIndexManagerExample.cs[tag=primary,indent=0]
----
...
[source,csharp]
----
include::example$QueryIndexManagerExample.cs[tag=secondary,indent=0]
----
...
[source,csharp]
----
include::example$QueryIndexManagerExample.cs[tag=defer-indexes,indent=0]
----

To delete a query index you can use the `DropIndexAsync()` or `DropPrimaryIndexAsync()` methods. 
Which one you use depends on the type of query index you want to drop from the cluster.

.Deleting an index

[source,csharp]
----
include::example$QueryIndexManagerExample.cs[tag=drop-primary-or-secondary-index,indent=0]
----

// * Search - note & link to Search page & API?
...
[source,csharp]
----
include::example$ProvisioningResourcesViews.cs[tag=viewmgr,indent=0]
----
...
[source,csharp]
----
include::example$ProvisioningResourcesViews.cs[tag=createView,indent=0]
----
...
[source,csharp]
----
include::example$ProvisioningResourcesViews.cs[tag=getView,indent=0]
----
...
[source,csharp]
----
include::example$ProvisioningResourcesViews.cs[tag=publishView,indent=0]
----
...
[source,csharp]
----
include::example$ProvisioningResourcesViews.cs[tag=removeView,indent=0]
----
