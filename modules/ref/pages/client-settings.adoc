...
Cluster Option: https://docs.couchbase.com/sdk-api/couchbase-net-client/api/Couchbase.ClusterOptions.html#Couchbase_ClusterOptions_NumKvConnections[`NumKvConnections(int)`]
+
Default:  `2`
+
...
Cluster Option: https://docs.couchbase.com/sdk-api/couchbase-net-client/api/Couchbase.ClusterOptions.html#Couchbase_ClusterOptions_MaxKvConnections[`MaxKvConnections(int)`]
+
Default: `5`
+
