...
* You have create a bucket (perhaps using the xref:6.5@server:manage:manage-settings/install-sample-buckets[travel-sample dataset], or by creating a new bucket).
