...
|Build from Source |Build the library from source https://github.com/couchbase/couchbase-net-client/tree/master[here]
|===
...
[source,csharp]
----
var cluster = Cluster.Connect("couchbase://localhost", "Administrator", "password");
----
...
The API reference is generated for each release and can be found http://docs.couchbase.com/sdk-api/couchbase-net-client-3.0.0-beta2/[here].
