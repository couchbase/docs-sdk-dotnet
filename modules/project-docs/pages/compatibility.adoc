...
:page-aliases: overview,migrate,compatibility-versions-features
...
The Couchbase .NET SDK is compatible with .NET framework 4.6.1+ on Windows. 
On both Windows and Ubuntu GNU/Linux, it is tested with .NET Standard 2.0, 
