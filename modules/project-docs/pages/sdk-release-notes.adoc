...
Missing ConfigureAwait False in AttemptContext causes build error in VS17.12

==== Improvements

* https://couchbasecloud.atlassian.net/browse/NCBC-3920[NCBC-3920]:
Rename Couchbase.Integrated.Transactions to Couchbase.Client.Transactions.

* https://couchbasecloud.atlassian.net/browse/NCBC-3919[NCBC-3919]:
TXNN - Final refactor to match initial commit.

* https://couchbasecloud.atlassian.net/browse/NCBC-3916[NCBC-3916]:
TXNN-130 - ExtThreadSafety implementation, SDK-side.

* https://couchbasecloud.atlassian.net/browse/NCBC-3915[NCBC-3915]:
TXNN - Allow TransactionConfig to configured via ClusterOptions.

* https://couchbasecloud.atlassian.net/browse/NCBC-3914[NCBC-3914]:
TXNN - Add extension flags for Integration, Thread Safe, and fix Integration name.
...
Rename parameter to Error CTOR from "err" to "cause".

* https://couchbasecloud.atlassian.net/browse/NCBC-3897[NCBC-3897]:
Add PreferReturns support for LookupIn, for internal use.

* https://couchbasecloud.atlassian.net/browse/NCBC-3845[NCBC-3845]:
Add ReadOnlySequence and IBufferWriter support to ITypeSerializer.
