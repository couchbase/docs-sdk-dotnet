...
https://packages.couchbase.com/clients/net/3.0/Couchbase-Net-Client-3.1.7.zip[Download] |
...
*https://issues.couchbase.com/browse/NCBC-2879[NCBC-2879]: Combi test failure: CollectionTests.CollectionIdChanged_RetriesAutomatically 
*https://issues.couchbase.com/browse/NCBC-2888[NCBC-2888]: Converting null literal or possible null value to non-nullable type

=== New Features and Behavioral Changes.

*https://issues.couchbase.com/browse/NCBC-2698[NCBC-2698]: Add FTS Support for Collections
*https://issues.couchbase.com/browse/NCBC-2881[NCBC-2881]: Use Hello to determine if collections are available
*https://issues.couchbase.com/browse/NCBC-2887[NCBC-2887]: Ensure CID value of 0 is not appended to the key
...
https://packages.couchbase.com/clients/net/3.0/Couchbase-Net-Client-3.1.6.zip[Download] |
