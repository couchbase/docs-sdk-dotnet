...
These pages cover the Ened-of-Life 3._x_ versions of the Couchbase .NET SDK.
For the latest, supported version of the SDK, see https://docs.couchbase.com/dotnet-sdk/current/project-docs/sdk-release-notes.html[here].
