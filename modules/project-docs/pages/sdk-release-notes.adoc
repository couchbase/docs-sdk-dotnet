...
==== Fixed Issues
* https://issues.couchbase.com/browse/NCBC-3599[NCBC-3599]: Fix SDK bugs related to Nullability of Increment, Decrement, and related options.
* https://issues.couchbase.com/browse/NCBC-3565[NCBC-3565]: Add error handling for "index does not exist" query error
* https://issues.couchbase.com/browse/NCBC-3635[NCBC-3635]: GetAnyReplica: AggregateException field is now accessible when DocumentUnretrievableException is thrown

==== New Features and Behavioral Changes
* https://issues.couchbase.com/browse/NCBC-3579[NCBC-3579]: Support DocumentNotLocked exception when collection.Unlock() is called on a document that is not locked.
* https://issues.couchbase.com/browse/NCBC-3606[NCBC-3606]: SDK Support for Scoped Search Indexes
* https://issues.couchbase.com/browse/NCBC-3596[NCBC-3596]: Support for maxTTL value of -1 for collection "no expiry"
