...
*https://issues.couchbase.com/browse/NCBC-3446[NCBC-3446]: Performer not handling all transactions query options
*https://issues.couchbase.com/browse/NCBC-3448[NCBC-3448]: IndexNotFoundException not raised when QueryIndexManager.watchIndex called with a non-existent index
*https://issues.couchbase.com/browse/NCBC-3460[NCBC-3460]: Null reference exception when bootstrapping a Memcached bucket
*https://issues.couchbase.com/browse/NCBC-3467[NCBC-3467]: Regression in lambda-based sub doc API due to LookupInResult changes
...
* https://issues.couchbase.com/browse/NCBC-3449[NCBC-3449]: LookupIn NullReferenceException when using a Transcoder
* https://issues.couchbase.com/browse/NCBC-3456[NCBC-3456]: Subdoc LookupIn with AccessDeleted(true) throws SubdocExceptionException
* https://issues.couchbase.com/browse/NCBC-3466[NCBC-3466]: FIT: Performer using default transcoder cannot get raw content
* https://issues.couchbase.com/browse/NCBC-3482[NCBC-3482]: Enable FF by default
* https://issues.couchbase.com/browse/NCBC-3130[NCBC-3130]: Use System.Text.Json to build/serialize in orphan reporting
* https://issues.couchbase.com/browse/NCBC-3402[NCBC-3402]: Improve trimming support for internal DI
* https://issues.couchbase.com/browse/NCBC-3404[NCBC-3404]: Use System.Text.Json for Eventing Management
* https://issues.couchbase.com/browse/NCBC-3405[NCBC-3405]: Add trimming annotations to LoggingMeter
* https://issues.couchbase.com/browse/NCBC-3420[NCBC-3420]: Use System.Text.Json for query plans
* https://issues.couchbase.com/browse/NCBC-3453[NCBC-3453]: Reduce Default HTTP Idle Timeout
* https://issues.couchbase.com/browse/NCBC-3471[NCBC-3471]: Make Couchbase.Extensions.DependencyInjection trim and AOT-compatible
