...
== Version 3.2.1 (09 Sept 2021)

Version 3.2.1 is the second release of the 3.2 series, featuring collections and scopes
...
* https://issues.couchbase.com/browse/NCBC-2697[NCBC-2697]: Eventing Management API
* https://issues.couchbase.com/browse/NCBC-2959[NCBC-2959]: Allow sdk to send either the hostname or IP Address while as the target host
