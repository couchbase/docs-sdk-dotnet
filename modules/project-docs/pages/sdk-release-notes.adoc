...
It is a minor version update to note the release of SDK API 3.6 features.
...
* https://issues.couchbase.com/browse/NCBC-3572[NCBC-3572]: Default CancellationTokens start at option creation instead of when requests are sent
* https://issues.couchbase.com/browse/NCBC-3760[NCBC-3760]: Passing an X509CertificateFactory breaks Http services (Auth failure)
* https://issues.couchbase.com/browse/NCBC-3768[NCBC-3768]: Search: Boolean search queries parameter validation, DisjunctionQuery default value sending
* https://issues.couchbase.com/browse/NCBC-3775[NCBC-3775]: Query: Throw IndexExistsException when appropriate
* https://issues.couchbase.com/browse/NCBC-3794[NCBC-3794]: Infinite loop in ConfigPushHandler

==== New Features and Behavioral Changes

* https://issues.couchbase.com/browse/NCBC-3788[NCBC-3788]: Support for base64 encoded vector types
* https://issues.couchbase.com/browse/NCBC-3797[NCBC-3797]: VectorSearch to Committed
