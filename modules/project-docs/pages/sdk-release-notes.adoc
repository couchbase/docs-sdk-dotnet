 ...
 * https://issues.couchbase.com/browse/NCBC-3367 [NCBC-3367]: FIT: Issue in returned QueryIndex: null values for Bucket, Scope and Collection names
 * https://issues.couchbase.com/browse/NCBC-3417 [NCBC-3417]: MutateIn modifies global Transcoder setting, possibly corrupting data for all other operations.
 * https://issues.couchbase.com/browse/NCBC-3433 [NCBC-3433]: Regression in 3.4.8 may cause IOException if Query has no content
