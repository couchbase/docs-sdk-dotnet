...
* https://issues.couchbase.com/browse/NCBC-3055[NCBC-3055]: 
Customer Requires a beta copy of .net SDK 3.2.6.
...
Ignore null reference exception in global config resolution is server is less than 6.5.
