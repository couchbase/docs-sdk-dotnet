...
// NB for 3.7.2, uncomment the comment in the 3.7.1 improvement.
...
* https://couchbasecloud.atlassian.net/browse/NCBC-4026[NCBC-4026]:
  Upgraded `Grpc.Net.Client` and other related Grpc dependencies due to https://nvd.nist.gov/vuln/detail/CVE-2023-32731[CVE-2023-32731] (https://osv.dev/vulnerability/GHSA-cfgp-2977-2fmm[GHSA-cfgp-2977-2fmm])
...
* https://couchbasecloud.atlassian.net/browse/NCBC-4016[NCBC-4016]:
  Stellar: Passing `null` content for `Insert`, `Replace` and `Upsert` now throws `InvalidArgumentException`.
