...
Cluster.Dispose safely ensures disposed ChannelConnectionPool objects cannot be re-used

* https://couchbasecloud.atlassian.net/browse/NCBC-4053[NCBC-4053]
`accessedDeleted` should be sent when using `ReadPreference`
...
* [NCBC-3996](https://couchbasecloud.atlassian.net/browse/NCBC-3996) 
