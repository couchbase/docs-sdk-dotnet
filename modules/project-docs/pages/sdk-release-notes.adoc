...
By default SDK3 sends the IP as the target host during TLS/SSL authentication, unlike SDK2 which sends either
the hostname or IP address depending on the returned server configuration.
