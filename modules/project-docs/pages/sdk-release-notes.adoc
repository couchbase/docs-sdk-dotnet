...
Version 3.4.14 is the fourteenth release of the 3.4 series.
...
==== Fixed Issues
* https://issues.couchbase.com/browse/NCBC-3434[NCBC-3434]:Regression: 
WaitUntilReady no longer detects state properly
