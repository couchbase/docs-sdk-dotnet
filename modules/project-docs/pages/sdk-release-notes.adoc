...
https://couchbasecloud.atlassian.net/browse/NCBC-3840[NCBC-3840] Rider IDE `:nq` is not a valid format specifier

https://couchbasecloud.atlassian.net/browse/NCBC-3878[NCBC-3878] Randomize seed order of hosts in the Connection string
...
https://couchbasecloud.atlassian.net/browse/NCBC-3879[NCBC-3879] .NET SDK sets span attributes on the wrong span

https://couchbasecloud.atlassian.net/browse/NCBC-3883[NCBC-3883] Update System.Text.Json dependency due to security vulnerability

==== Improvement

https://couchbasecloud.atlassian.net/browse/NCBC-3851[NCBC-3851] SDK: More Contextual Labels in Metrics


=== Version 3.6.3 (19 September 2024)

Version 3.6.3 is a hotfix release.
Some NuGet packages were upgraded as a result of high impact security issues. https://couchbasecloud.atlassian.net/browse/NCBC-3839[NCBC-3839]
...
==== Fixed Issues
https://couchbasecloud.atlassian.net/browse/NCBC-3863[NCBC-3863] Performance problems and timeouts during rebalance when the cluster contains non-KV nodes.

https://couchbasecloud.atlassian.net/browse/NCBC-3832[NCBC-3832] Query timeout cannot exceed 100 seconds

https://couchbasecloud.atlassian.net/browse/NCBC-3818[NCBC-3818] QueryErrorContext "`Statement`" parameter is not set properly

https://couchbasecloud.atlassian.net/browse/NCBC-3842[NCBC-3842] Newtonsoft deserializing UTF8 surrogate pairs can cause exceptions or buffer overflow

https://couchbasecloud.atlassian.net/browse/NCBC-3849[NCBC-3849] Orphaned responses aren't sent to metrics for untraced operations

https://couchbasecloud.atlassian.net/browse/NCBC-3850[NCBC-3850] Timeouts are not recorded to metrics in ClusterNode.ExecuteOp

https://couchbasecloud.atlassian.net/browse/NCBC-3852[NCBC-3852] TryReadMutationToken doesn't check header length

https://couchbasecloud.atlassian.net/browse/NCBC-3854[NCBC-3854] (test only) LightweightStopwatch unit test is flaky

https://couchbasecloud.atlassian.net/browse/NCBC-3876[NCBC-3876] CancellationTokenSource is not disposed when returned to pool on legacy frameworks

==== Improvement

https://couchbasecloud.atlassian.net/browse/NCBC-3839[NCBC-3839] Update packages based on BlackDuck scan, High Impact packages

https://couchbasecloud.atlassian.net/browse/NCBC-3710[NCBC-3710] Include operation outcome tag in operation metrics

https://couchbasecloud.atlassian.net/browse/NCBC-3837[NCBC-3837] Provide easy configuration to exclude duplicative metrics from OpenTelemetry
