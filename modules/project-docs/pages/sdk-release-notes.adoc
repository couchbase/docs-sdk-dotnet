...
Version 3.6.2 is a hotfix releases. Microsoft disclosed a CVE affecting their System.Text.Json (STJ) library on the 9th of July 2024. 
...
Vulnerability in System.Text.Json 8.0.0

==== Improvements

* https://issues.couchbase.com/browse/NCBC-3821[NCBC-3821]:
 Update CouchbaseNetClientReleasedVerison to 3.6.2

* https://issues.couchbase.com/browse/NCBC-3726[NCBC-3726]: 
Apply some miscellaneous performance optimizations to transcoders

* https://issues.couchbase.com/browse/NCBC-3795[NCBC-3795]: 
Reduce duplicate operation handling code in ClusterNode
