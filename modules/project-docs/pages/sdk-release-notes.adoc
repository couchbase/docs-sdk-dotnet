...
https://packages.couchbase.com/clients/net/3.0/CouchbaseNetClient.3.0.0-beta1.zip[Download] | API https://docs.couchbase.com/sdk-api/couchbase-net-client-3.0.0-beta1[Reference] | https://www.nuget.org/packages/CouchbaseNetClient/3.0.0-beta1[Nuget]
