...
LoggingMeter prints wrong percentiles
...
SubdocExceptionException should be SubdocException
* https://issues.couchbase.com/browse/NCBC-3336[NCBC-3336]: 
QueryIndex missing get collectionName
* https://issues.couchbase.com/browse/NCBC-3564[NCBC-3564]: 
No error is thrown if the Cluster and/or Bucket auth fails
* https://issues.couchbase.com/browse/NCBC-3604[NCBC-3604]: 
FTS: TermRangeQuery does not have a Term parameter
...
GetAnyReplica: AggregateException field is not accessible 
...
LookupIn path too long is returning System error rather than Couchbase error
* https://issues.couchbase.com/browse/NCBC-3646[NCBC-3646]: 
LookupIn replicas not available tests failing on servers without support
...
FIT KV: Subdoc Get with empty path throws instead of returning full document
* https://issues.couchbase.com/browse/NCBC-3661[NCBC-3661]: 
Ensure NRE not thrown when node does not support mgmt
* https://issues.couchbase.com/browse/NCBC-3664[NCBC-3664]: 
FIT KV: SDK sets the expiry of a GetResult when is is 0
* https://issues.couchbase.com/browse/NCBC-3666[NCBC-3666]: 
FIT KV: Get test with too long ID fails
* https://issues.couchbase.com/browse/NCBC-3676[NCBC-3676]: 
Make StellarQueryRequest read metadata first after sending query
* https://issues.couchbase.com/browse/NCBC-3679[NCBC-3679]: 
DebuggerDisplay:nq should be DebuggerDisplay,nq
* https://issues.couchbase.com/browse/NCBC-3686[NCBC-3686]: 
FIT Vector Search: Sending 0 elements doesn&#39;t throw InvalidArgumentException
* https://issues.couchbase.com/browse/NCBC-3696[NCBC-3696]: 
Bad URI for scoped indexes in SearchIndexManager
* https://issues.couchbase.com/browse/NCBC-3701[NCBC-3701]: 
VectorSearch missing API overloads according to RFC.
* https://issues.couchbase.com/browse/NCBC-3705[NCBC-3705]: 
fix spelling error in ClusterOptions code comments
...
FeatureNotAvailable if new search capabilities aren&#39;t available
* https://issues.couchbase.com/browse/NCBC-3620[NCBC-3620]: 
Remove uneeded async and awaits from PS
* https://issues.couchbase.com/browse/NCBC-3617[NCBC-3617]: 
ConnectionString refactoring for Stellar and &quotcouchbase2://&quot; scheme
* https://issues.couchbase.com/browse/NCBC-3667[NCBC-3667]: 
Retry when retry-now is returned by the server
* https://issues.couchbase.com/browse/NCBC-3671[NCBC-3671]: 
FIT Management: Implement SearchIndexManagement 
