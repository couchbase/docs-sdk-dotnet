...
* **Protostellar**: This release introduces full support for Protostellar (the Couchbase Network Gateway).
Protostellar provides a high-performance, gRPC-based gateway for Couchbase Server, offering improved scalability and simplified connectivity in cloud-native environments.
