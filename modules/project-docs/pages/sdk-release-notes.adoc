...
* https://issues.couchbase.com/browse/NCBC-3745[NCBC-3745]: ObjectDisposedException when fetching a config
* https://issues.couchbase.com/browse/NCBC-3756[NCBC-3756]: Handle empty VBucketMap in server config
* https://issues.couchbase.com/browse/NCBC-3758[NCBC-3758]: PersistentQueue does not dequeue items in original FIFO order
* https://issues.couchbase.com/browse/NCBC-3764[NCBC-3764]: GetAnyReplica / TaskHelpers.WhenAnySuccessful can potentially cause deadlocks using .NET Framework
* https://issues.couchbase.com/browse/NCBC-3769[NCBC-3769]: SDK fails to adapt to new cluster topology if only a port changed
* https://issues.couchbase.com/browse/NCBC-3772[NCBC-3772]: Cluster config maps are reaching BucketBase.CurrentConfig, affecting scope/collection capabilities

==== New Features and Behavioral Changes

* https://issues.couchbase.com/browse/NCBC-1622[NCBC-1622]: Add Snappy Compression Feature to the SDK
* https://issues.couchbase.com/browse/NCBC-3738[NCBC-3738]: Support for scoped eventing functions
* https://issues.couchbase.com/browse/NCBC-3746[NCBC-3746]: Apply performance optimizations to ArrayExtensions
* https://issues.couchbase.com/browse/NCBC-3759[NCBC-3759]: Capture ExceptionDispatchInfo at time the exception is caught
* https://issues.couchbase.com/browse/NCBC-3770[NCBC-3770]: Reduce the amount of DEBUG logging around Config Push
