...
* https://issues.couchbase.com/browse/NCBC-3248[NCBC-3248]: Bootstrap should continue after AuthenticationFailureException
* https://issues.couchbase.com/browse/NCBC-3252[NCBC-3252]: Wrong error message when bootstrapping

=== New Features and Behavioral Changes

* https://issues.couchbase.com/browse/NCBC-2178[NCBC-2178]: Set up Combination Testing for SDK 3 - Server 5.5, 6.0, 6.5
* https://issues.couchbase.com/browse/NCBC-3193[NCBC-3193]: Restore TLS error message, but only when cert error encountered.
* https://issues.couchbase.com/browse/NCBC-3254[NCBC-3254]: OpenTelemetry.UnitTests.MeterTests.BasicMetric_IsExported 
* https://issues.couchbase.com/browse/NCBC-2998[NCBC-2998]: Exception cannot be handled as a CouchbaseException
* https://issues.couchbase.com/browse/NCBC-3253[NCBC-3253]: Don't export fuzziness or prefix_length when values less than 1
