...
https://packages.couchbase.com/clients/net/3.0/CouchbaseNetClient.3.0.0-alpha4.zip[Download] | NA[API Reference] | https://www.nuget.org/packages/CouchbaseNetClient/3.0.0-alpha4[Nuget]
