...
Note: as of 3.2.5 .NET Core 2.1 support has been dropped from the SDK. This corresponds to Microsoft's decision to EOL .NET Core 2.1 on August 21, 2021.
...
Improve error handling in QueryIndexManager.
...
Bootstrapper continues processing after cluster dispose.

* https://issues.couchbase.com/browse/NCBC-3096[NCBC-3096]: 
Cleanup CancellationTokenSource handling in ConfigHandler.

* https://issues.couchbase.com/browse/NCBC-3100[NCBC-3100]: 
Include lastDispatchedFrom and LastDispactedTo in IErrorContext implementations.

* https://issues.couchbase.com/browse/NCBC-3102[NCBC-3102]:
Orphaned report is associating remote host with local host.

* https://issues.couchbase.com/browse/NCBC-3107[NCBC-3107]: 
IQueryIndexManager doesn&#39;t accept bucket names already in backticks.

* https://issues.couchbase.com/browse/NCBC-3109[NCBC-3109]: 
Quota Limited Exceptions not being thrown for some Management apis.

=== New Features and Behavioral Changes

* https://issues.couchbase.com/browse/NCBC-3052[NCBC-3052]:
Update FTS Rate Limit Parsing.

* https://issues.couchbase.com/browse/NCBC-3094[NCBC-3094]: 
Address sporadic unit tests failures on build agents.

* https://issues.couchbase.com/browse/NCBC-2964[NCBC-2964]: 
Query - Add Support to Preserve TTL.

* https://issues.couchbase.com/browse/NCBC-2973[NCBC-2973]: 
Index Management API - Provide ability to manage indexes for a collection.

* https://issues.couchbase.com/browse/NCBC-3035[NCBC-3035]:
Improve performance and trimmability of EnumExtensions.

* https://issues.couchbase.com/browse/NCBC-3036[NCBC-3036]: 
Add tracing spans for compression/decompression.

* https://issues.couchbase.com/browse/NCBC-3059[NCBC-3059]: 
Reduce heap allocations surrounding OperationCancellationRegistration.

* https://issues.couchbase.com/browse/NCBC-3063[NCBC-3063]: 
Replace Stopwatch in AsyncState with a lightweight approach.

* https://issues.couchbase.com/browse/NCBC-3075[NCBC-3075]: 
Support projections with System.Text.Json.

* https://issues.couchbase.com/browse/NCBC-3077[NCBC-3077]: 
Remove limitations on System.Text.Json.

* https://issues.couchbase.com/browse/NCBC-3089[NCBC-3089]:
Clone QueryOptions to avoid reuse and potential threading issues.

* https://issues.couchbase.com/browse/NCBC-3097[NCBC-3097]: 
Use TaskCreationOptions.RunContinuationsAsynchronously.

* https://issues.couchbase.com/browse/NCBC-3101[NCBC-3101]: 
Use System.Text.Json for bootstrap and internal K/V operations.
