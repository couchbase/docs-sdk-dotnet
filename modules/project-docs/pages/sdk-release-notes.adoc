...
Version 3.3.5 is the fifth release of the 3.3 series.
...
KV Failure when using Memcached Bucket

=== New Features and Behavioral Changes

* https://issues.couchbase.com/browse/NCBC-3158[NCBC-3158]:
Concurrency Testing: Run in Jenkins
* https://issues.couchbase.com/browse/NCBC-2193[NCBC-2193]:
Ensure combination testing runs for branches other than master
