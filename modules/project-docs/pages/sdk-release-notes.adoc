...
Stellar: Subdoc Mutation Array now handles `removeBrackets` bool properly.
...
Stellar: Some new `BucketSettings` fields have been added to the request.

* https://couchbasecloud.atlassian.net/browse/NCBC-4016[NCBC-4016]:
Stellar: Passing `null` content for `Insert`, `Replace`, or `Upsert` now throws `InvalidArgumentException`.
