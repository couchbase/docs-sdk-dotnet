...
* https://issues.couchbase.com/browse/NCBC-2974[NCBC-2974] : CidLock may be incorrectly released
* https://issues.couchbase.com/browse/NCBC-2985[NCBC-2985] : HTTP streaming not used as fallback for getting Cluster Config
* https://issues.couchbase.com/browse/NCBC-2989[NCBC-2989] : Fix side effects related to singleton CouchbaseHttpClient

=== New Features and Behavioral Changes.

* https://issues.couchbase.com/browse/NCBC-2979[NCBC-2979] : Support Error Map v2
* https://issues.couchbase.com/browse/NCBC-2987[NCBC-2987] : Update NuGet package info.
* https://issues.couchbase.com/browse/NCBC-2477[NCBC-2477] : Replace HttpClientHandler with SocketsHttpHandler
* https://issues.couchbase.com/browse/NCBC-2859[NCBC-2859] : Complete FLE including RSA on upgrade
* https://issues.couchbase.com/browse/NCBC-2865[NCBC-2865] : Improve bucket configuration handling (revEpoch)
* https://issues.couchbase.com/browse/NCBC-2992[NCBC-2992] : Rename BucketBase.BucketConfig to BucketBase.CurrentConfig
