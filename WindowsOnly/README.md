...
- **Couchbase.Examples.Logging.FullFramework** — targets full .NET Framework (`v4.7.2`)
  and demonstrates log4net integration. The project lives under
  `modules/howtos/examples/logging/windows/` so its Antora `example$` includes keep
  resolving; this solution just references it from here.
